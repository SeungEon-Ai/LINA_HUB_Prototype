...
Streamlit으로 만든 라이나 HUB 데모 앱입니다. 보험 약관, 보험용어, 고객센터 FAQ, 보험뉴스, 생활형 테스트 기능을 한 화면에서 탐색할 수 있도록 구성했습니다. 내부 공유에서 바로 실행해볼 수 있도록 홈 화면, 좌측 관심사 메뉴, 우측 이벤트/상담 카드, 기능별 배너와 설명 영역을 맞춰두었습니다.
